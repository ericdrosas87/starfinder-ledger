...
function GMLedgerButton(sheet)
{
    ...
    const pfDetailsTab = sheet.element[0].querySelector('#settings-game');
    ...
    openGMLedgerButton.textContent = "Starfinder Ledger";
    // openGMLedgerButton.title = openLedgerTooltip;
    openGMLedgerButton.title = "test";
    openGMLedgerButton.id = "StarfinderGMLedgerButton";
